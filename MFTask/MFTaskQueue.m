...
- (void) launchTasksIfNeeded {
	...
	for(MFTask *task in tasks){
		...
		if ( ![task hasLaunched] && (maxNumToLaunch>0) ){
			...
			[task addObserver:self forKeyPath:@"isFinished" options:0 context:(__bridge void *)(MFTaskQueueKVOObservingContext)];
...
-(void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary *)change 
    ...
    if ( (context==(__bridge void *)(MFTaskQueueKVOObservingContext)) && [keyPath isEqualToString:@"isFinished"] ) {
